...
java -jar xdbinstalldir_placeholder/bin/edb-repcli.jar -createsub xdbsub -subsvrfile xdbinstalldir_placeholder/etc/xdb_subsvrfile.conf -subdbid `java -jar /usr/ppas-xdb-6.0/bin/edb-repcli.jar -printsubdbids -repsvrfile /usr/ppas-xdb-6.0/etc/xdb_subsvrfile.conf | tail -n 1` -pubsvrfile xdbinstalldir_placeholder/etc/xdb_repsvrfile.conf -pubname xdbtest
