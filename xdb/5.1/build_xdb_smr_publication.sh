...
java -jar ${XDB_HOME}/bin/edb-repcli.jar -createsub xdbsub -subsvrfile ${XDB_HOME}/etc/xdb_subsvrfile.conf -subdbid 1 -pubsvrfile ${XDB_HOME}/etc/xdb_repsvrfile.conf -pubname xdbtest
